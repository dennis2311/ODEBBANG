  ...
  return (
    <div className="wrapper">
      <div className="header_vote">
        <div className="crop">
          <img src="src/Resource/share_eagle.svg" alt="" />
        </div>
        <div className="header_text">투표 현황</div>
        <div className="crop">
          <img src="src/Resource/share_tiger.svg" alt="" />
        </div>
      </div>
      <div
        className="versus"
      ...
      <div className="share">
        ...
        <div className="share_kakao">
          <img
            src="src/Resource/share_kakao.svg"
            alt=""
            className="share_kakao_logo"
          />
