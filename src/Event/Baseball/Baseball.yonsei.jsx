...
export function BaseballYonsei({ goNextEvent }) {
  ...
  const yabaweeAnimation = () => {
    ...
    setTimeout(() => {
      ...
      koreaLogo.src = "src/Resource/yonsei_logo.svg";
      var buttons = document.getElementsByClassName("button-container");
      for (const button of buttons) {
    ...
    <div className="page-wrapper">
      ...
      <div className="body-container">
        ...
        <img
          ...
          src="src/Resource/baseball-ball.svg"
          alt="야구공"
        />
      </div>
      <div className="buttons-container">
        ...
        <img className="cup left" src="src/Resource/yabawee_cup.svg" />
        <img className="cup right" src="src/Resource/yabawee_cup.svg" />
        <img
